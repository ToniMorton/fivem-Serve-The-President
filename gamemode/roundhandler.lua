...
AddEventHandler("stp:client:RoundEnd", function(name)
    ...
    Citizen.CreateThread(function()
		...
		Citizen.Trace("POP UP SPAWN MENU TIMEEEEE")
		Citizen.Wait(4000)
		TriggerServerEvent("ptp:removeallveh")
		TriggerServerEvent("ptp:showspawnmenu")
		TriggerServerEvent("ptp:vehspawnreset")
		TriggerServerEvent("ptp:postteamcount", GetPlayerServerId(PlayerId()))
